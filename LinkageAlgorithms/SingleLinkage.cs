...
namespace Clustering.LinkageAlgorithms
{
    ...
    /// <summary>
    /// Distance between two clusters is the distance between their closest
    /// elements (nearest neighbor method). This algorithm is contracting and
    /// appropriate to identify outliers but tends to chaining effects.
    /// </summary>
